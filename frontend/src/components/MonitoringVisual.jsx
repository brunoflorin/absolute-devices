...
const sections = [
  ...
  },
  {
    ...
    items: [
      {
        src: "/visuels/Long_Versions/Monitoring_Atera_PRTG_Centreon_NinjaOne_LongVersion.pdf",
        label: "Monitoring : Atera, PRTG, Centreon, NinjaOne",
      },
    ],
  },
  {
    ...
    items: [
      {
        src: "/visuels/Educative_Versions/Atera_vs_BeMSP_vs_NinjaOne_vs_Centreon_vs_PRTG.png",
        label: "Comparatif des plateformes de monitoring",
      },
      {
        src: "/visuels/Educative_Versions/Atera.png",
        label: "Atera",
      },
      {
        src: "/visuels/Educative_Versions/Centreon.png",
        label: "Centreon",
      },
      {
        src: "/visuels/Educative_Versions/NinjaOne.png",
        label: "NinjaOne",
      },
      {
        src: "/visuels/Educative_Versions/PRTG.png",
        label: "PRTG",
      },
    ],
  },
