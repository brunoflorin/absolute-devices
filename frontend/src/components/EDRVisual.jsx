...
const sections = [
  {
    ...
    items: [
      {
        src: "/visuels/Short_Versions/Trend_Micro_Worry_Free_for_Business.pdf",
        label: "Trend Micro Worry-Free for Business",
      },
    ],
  },
  {
    ...
    items: [
      {
        src: "/visuels/Long_Versions/EDR_XDR_MDR_Antivirus_LongVersion.pdf",
  ...
  },
  {
    ...
    items: [
      {
        src: "/visuels/Educative_Versions/Acronis_EDR.png",
        label: "Illustration EDR",
      },
      {
        src: "/visuels/Educative_Versions/TrendMicro.png",
        label: "Illustration Trend Micro",
      },
    ],
  },
];
